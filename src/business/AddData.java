...
public class AddData {
            ...
            
    {
       ...
       pharma1.setStoreName("pharmacy 1");
       pharma2.setStoreName("pharmacy 2");
      ...
      pharmaDirectory.addPharmacy(pharma2);
        ...
        //drug2.setDrugID(2);
        drug2.setDrugName("digas");
        drug2.setDrugType("digas");
        ...
        //drug12.setDrugID(3);
        drug12.setDrugName("amoxil");
        drug12.setDrugType("amoxil");
        drug12.setComposition("antibiotic ");
    ...
    public void setStoreInitialValues(StoreDirectory storeDirectory){
        ...
        store2.setStoreLocation("Islamabad");
        sd.addStore(store2);
