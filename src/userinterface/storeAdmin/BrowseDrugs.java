...
public class BrowseDrugs extends javax.swing.JPanel {
   ...
   // private MasterOrderCatalog masterOrderCatalog;
    ...
    public void populatePharmacyCombo(){
       ...
       if(pharmacy!=null){
        for (Medicine drug : pharmacy.getDrugCatalog().getDrugList())
        {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Pharmacy Medicine Catalog");
        ...
        viewProdjButton2.setText("View Medicine Detail");
        ...
        jLabel3.setText("Order items from Bahria pharmacy");
        jLabel3.setIconTextGap(7);
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 40, -1, 30));
    ...
    private void viewProdjButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewProdjButton2ActionPerformed
        ...
        Medicine drug = (Medicine) drugTable.getValueAt(selectedRow, 0);
        ViewMedicineDetailJPanel viewDrugDetails = new ViewMedicineDetailJPanel(userProcessContainer,drug);
    ...
    private void addtoCartButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addtoCartButton6ActionPerformed
        ...
        if(selectedRow<0){
            ...
            selectedDrug = (Medicine) drugTable.getValueAt(selectedRow, 0);
        }
    ...
    private void btnSearchProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchProductActionPerformed
        ...
        if(txtSearchKeyWord.getText().trim().length() >= 0){
           try {
               ...
               Medicine drug = pharmacyDirectory.searchDrug(drugID);
               if(drug!=null){
               ViewMedicineDetailJPanel viewDrugDetail = new ViewMedicineDetailJPanel(userProcessContainer, drug);
